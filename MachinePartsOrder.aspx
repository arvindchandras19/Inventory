<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MachinePartsOrder.aspx.cs" MasterPageFile ="~/Inven.Master" Inherits="WebApplication1.MachinePartsOrder" %>
                                        ...
                                        <asp:BoundField DataField="EquipementListID" HeaderText="EquipementListID" HeaderStyle-CssClass="HeaderHide" ItemStyle-CssClass="HeaderHide" />--%>
                                                     ...
                                                     <%--           <span style="font-weight: 600">Date Created: </span>--%>
                                                        ...
                                                        <asp:TemplateField HeaderText="Remarks" HeaderStyle-Width="6%" ItemStyle-Width="6%">
                                                            <ItemTemplate>
                                                                <asp:Image ID="Image2" runat="server" Visible="false" ImageUrl="~/Images/Readmore.png" ImageAlign="Right" Height="40px" data-content='<%# Eval("Remarks")%>' data-toggle="popover" />
