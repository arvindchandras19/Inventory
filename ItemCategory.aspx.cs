...
namespace WebApplication1
{
    public partial class ItemCategory : System.Web.UI.Page
    {
        ...
        protected void btnprint_Click(object sender, EventArgs e)
        {
            ...
            List<GetCategoryReport_Result> llstreview = lclsService.GetCategoryReport(lcls).ToList();
        ...
        public void Search()
        {
            try
            {
                ...
                lcls.IsStrActive = reactive.SelectedValue;
                lcls.LoggedinBy = defaultPage.UserId;
                List<SearchItemCategory_Result> lstcol = lclsService.SearchItemCategory(lcls).ToList();
