    ...
    public partial class CapitalOrder : System.Web.UI.Page
    {
        ...
        public void BindRequestPOGrid()
        {
            try
            {
                ...
                List<SearchCapitalPO_Result> lstCRMaster = lclsservice.SearchCapitalPO(llstcr).ToList();
            ...
            try
            {
                ...
                if (ReviewCount != 0)
                {
                    ...
                    if (CPOIns == "Saved Successfully")
                    {
                        ...
                        List<GetCapitalOrderCPONo_Result> llstr = lclsservice.GetCapitalOrderCPONo(Convert.ToString(ViewState["ReqID"])).ToList();
        ...
        public List<object> DetailsOrderReport(Int64 CRmasterID)
        {
            ...
            List<GetCROrderContentPO_Result> llstreview = lclsservice.GetCROrderContentPO(llscr).ToList();
        ...
        protected void lbCRrno_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                List<GetCapitalItemMaster_Result> lstCR = lclsservice.GetCapitalItemMaster().Where(a => a.CapitalItemMasterID == Convert.ToInt64(HdnMasterID.Value)).ToList();
                ...
                List<GetCapitalItemDetails_Result> llstCRDetails = lclsservice.GetCapitalItemDetails(Convert.ToInt64(HdnMasterID.Value), defaultPage.UserId, Convert.ToInt64(LockTimeOut)).ToList();
