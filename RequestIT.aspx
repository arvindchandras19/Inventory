<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile ="~/Inven.Master" CodeBehind="RequestIT.aspx.cs" Inherits="WebApplication1.RequestIT" %>
                                        ...
                                        <asp:TemplateField HeaderText="Qty" HeaderStyle-Width="10%">
                                            ...
                                            <FooterTemplate>
                                                ...
                                                <asp:TextBox ID="FooteOrderQuantity" runat="server" Width="75%" />
                                                 <asp:Label ID="Label1" runat="server" Text='<%# Eval("OrderQuantity") %>' CssClass="hidden"/>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Total Price($)">
                                            <ItemTemplate>
                                                ...
                                                <ajax:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" FilterType="Numbers,Custom" ValidChars=".$" runat="server" TargetControlID="txttotprice"></ajax:FilteredTextBoxExtender>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Reason">
                                            <ItemTemplate>
