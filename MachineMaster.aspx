<%@ Page Language="C#" Title="Machine Master" AutoEventWireup="true" MasterPageFile ="~/Inven.Master" CodeBehind="MachineMaster.aspx.cs" Inherits="WebApplication1.MachineMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
        ...
        <asp:Panel ID="pnlrestore" runat="server" BackColor="White" CssClass="panel"
            ...
            <table style="border: Solid 2px #f0ad4e; width: 100%; height: 100%"
                ...
                <tr>
                    <td colspan="2" align="left" style="padding: 5px; font-family: Calibri">
                        <asp:Label ID="Label2" runat="server" Text="Do you want to Restore this Record?" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2"></td>
