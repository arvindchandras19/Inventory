    ...
    public partial class EndingInventory : System.Web.UI.Page
    {
        ...
        public void BindCategory()
        {
            try
            {
                if (drpvendorsearch.SelectedValue != "")
                {
                    ...
                    InventoryServiceClient lclsservice = new InventoryServiceClient();
                    List<GetCategoryByListVendorID_Result> lstcategory = new List<GetCategoryByListVendorID_Result>();
        ...
        public void BindEndingInvenGrid(string ChkAdd)
        {
            try
            {
                ...
                List<SearchEndingInventory_Result> lstSRPOMaster = new List<SearchEndingInventory_Result>();
        ...
        protected void lblReceiveingInven_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                List<GetReceivedQtyInfo_Result> llstReceivedinfo = lclsservice.GetReceivedQtyInfo(llstEndingInventory).ToList();
        ...
        protected void lblTransferIn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                List<GetTransferINQtyInfo_Result> llstReceivedinfo = lclsservice.GetTransferINQtyInfo(llstEndingInventory).ToList();
        ...
        protected void lnkTransferOut_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                List<GetTransferOutQtyInfo_Result> llstReceivedinfo = lclsservice.GetTransferOutQtyInfo(llstEndingInventory).ToList();
        ...
        public void DetailEndingInventory()
        {
            ...
            try
            {
                ...
                List<EndingInventoryReport_Result> lstEndingInventoryReport = lclsservice.EndingInventoryReport(llstEndingInventory).ToList();
