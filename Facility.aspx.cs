...
namespace WebApplication1
{
    public partial class Facility : System.Web.UI.Page
    {
        ...
        public void GetFacility()
        {
            try
            {
                List<GetFacility_Result> lstfac = lclsservice.GetFacility().ToList();
        ...
        public void GetState()
        {
            try
            {
                List<GetState_Result> lstpatin = lclsservice.GetState().ToList();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                List<BindFacility_Result> lstcol = lclsservice.BindFacility(lclfacility).Where(a => a.FacilityShortName == lclfacility.FacilityShortName).ToList();
        ...
        public void BindFacility()
        {
            try
            {
                ...
                lclfacility.LogginBy = defaultPage.UserId;
                lclfacility.Filter = "";
                List<BindFacility_Result> lstcol = lclsservice.BindFacility(lclfacility).ToList();
        ...
        public void BindUserRoleFacility()
        {
            try
            {
                ...
                List<GetUserRoleForFacility_Result> lstcol = lclsservice.GetUserRoleForFacility(Convert.ToInt64(hiddenFacilityID.Value), FinalString).ToList();
        ...
        public List<object> PrintFacility()
        {
            ...
            lclfacility.LogginBy = defaultPage.UserId;
            lclfacility.Filter = "";
            List<BindFacility_Result> llstreview = lclsservice.BindFacility(lclfacility).ToList();
        ...
        public void BindUserRoles()
        {
            try
            {
                List<BindRolesForFacility_Result> lstRoles = new List<BindRolesForFacility_Result>();
                ...
                foreach (ListItem lst in drpUserRole.Items)
                {
                    List<BindRolesForFacility_Result> lstdrp = lclsservice.BindRolesForFacility(Convert.ToInt64(hiddenFacilityID.Value)).Where(a => a.UserRoleID == Convert.ToInt64(lst.Value) && a.UserType == "System").ToList();
                    if (lstdrp.Count > 0)
                    {
        ...
        public List<object> PrintFacilityDetails()
        {
            ...
            lclfacility.LogginBy = defaultPage.UserId;
            lclfacility.Filter = "";
            List<BindFacilityDetailsReport_Result> llstreview = lclsservice.BindFacilityDetailsReport(lclfacility).ToList();
            //List<GetMedicalSupplyPoReportDetails> llstreview = lclsservice.GetMedicalSupplyPoReportDetails(PRmasterID, null, defaultPage.UserId).ToList();
