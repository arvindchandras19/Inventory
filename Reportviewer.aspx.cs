...
namespace WebApplication1
{
    public partial class Reportviewer : System.Web.UI.Page
    {
        ...
        public void BindVendor()
        {
            try
            {
                List<GetVendor_Result> lstvendor = new List<GetVendor_Result>();
        ...
        public void BindScreen()
        {
            try
            {
                List<GetdrpSubMenu_Result> lstitem = new List<GetdrpSubMenu_Result>();
        ...
        [WebMethod]
        public static List<GetList_Result> BindSubReport(string drpreporttext)
        {
            try
            {
                InventoryServiceClient lclsservice = new InventoryServiceClient();
