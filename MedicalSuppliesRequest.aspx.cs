...
namespace WebApplication1
{
    public partial class MedicalSuppliesRequest : System.Web.UI.Page
    {
        ...
        public void BindAddMedicalsupplies()
        {
            try
            {
                List<GetMedicalsuppliesItem_Result> lstmedgrid = new List<GetMedicalsuppliesItem_Result>();
        ...
        public void SearchGrid()
        {
            try
            {
                ...
                List<SearchMedicalSupplyRequest_Result> lstMSRMaster = lclsservice.SearchMedicalSupplyRequest(llstMachineSearch).ToList();
        ...
        protected void btnReview_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (GridViewRow row in grdMedReqadd.Rows)
                {
                    ...
                    if (txtqihand.Text != "")
                    {
                        List<ValidateMedicalSuppliesItem_Result> valMedicalSupp = lclsservice.ValidateMedicalSuppliesItem(llstMedicalSupplyRequest).ToList();
        ...
        public void PurchaseOrderEditFunction(Int64 MedicalsuppliesID)
        {
            try
            {
                ...
                List<BindMedicalsupplymaster_Result> lstmstrdetail = new List<BindMedicalsupplymaster_Result>();
                ...
                if (lstmstrdetail.Count > 0)
                {
                    ...
                    List<BindMedicalsupplyDetail_Result> llstMedicalSupplyRequest = lclsservice.BindMedicalsupplyDetail(MedicalsuppliesID, Convert.ToInt64(defaultPage.UserId), Convert.ToInt64(LockTimeOut)).ToList();
                    ...
                    if (llstMedicalSupplyRequest.Count > 0)
                    {
                        if (llstMedicalSupplyRequest[0].MedicalsuppliesItemID != 0)
                        {
                            ...
                            else if (llstMedicalSupplyRequest[0].IsReadOnly == 1)
                            {
                                ...
                                List<GetUserDetails_Result> llstuserdetails = lclsservice.GetUserDetails(Convert.ToInt64(llstMedicalSupplyRequest[0].Lockedby)).ToList();
        ...
        public void BindOrderPeriod()
        {
            try
            {
                ...
                lst.Value = "0";
                lst.Text = "Select";
                List<GetOrderPeriod_Result> lstvendordetails = new List<GetOrderPeriod_Result>();
                Int64 Vendor = 0;
                if (ddlVendoradd.SelectedValue == "")
                {
                    Vendor = 0;
        ...
        protected void btnaddshipping_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                BindShipping("Add");
                List<SavedShippingValue_Result> lstship = new List<SavedShippingValue_Result>();
        ...
        protected void btntimedelsave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                BindTimeDelivery("Add");
                List<SavedTimeDeliveryValue_Result> lsttimedel = new List<SavedTimeDeliveryValue_Result>();
        ...
        public void BindRemainingItemGrid()
        {
            try
            {
                ...
                List<AddMedicalsupplyitem_Result> lstMSRMaster = lclsservice.AddMedicalsupplyitem(Objmsr).ToList();
                    ...
                    if (rowcount != 0)
                    {
                        if (ReviewCount != 0)
                        {
                            ...
                            if (s != "")
                            {
                                ...
                                {
                                    List<GetMedicalSupplyRequestMaster_Result> lstMSRMaster = lclsservice.GetMedicalSupplyRequestMaster().ToList();
