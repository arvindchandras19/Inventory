<%@ Page Title="Request-Machine Parts" Language="C#" AutoEventWireup="true" CodeBehind="MachinePartRequest.aspx.cs" MasterPageFile ="~/Inven.Master" Inherits="WebApplication1.MachinePartRequest" %>
                                    ...
                                    <asp:TemplateField HeaderText="Audit Trail" HeaderStyle-Width="6%">
                                      ...
                                      <asp:TemplateField HeaderText="Remarks" HeaderStyle-Width="6%">
                                            <ItemTemplate>
                                                ...
                                                <%--<asp:Label ID="lblRemarks" runat="server" Text=' <%# Eval("Remark")%>'></asp:Label>--%>
                                                <%-- <a tabindex="0" class="" role="button" data-toggle="popover" data-trigger="focus" title="Dismissible popover" data-content="<%# Eval("Remark").ToString() %>"><%#Eval ("Remark").ToString().Length > 100 ? Eval("Remark").ToString().Substring(0,100) + "..."+"<img style='height:30px;' src='Images/Readmore.png'></img>" : Eval("Remark").ToString() %></a>--%>
                                                <asp:Image ID="Image2" runat="server" ImageUrl="~/Images/Readmore.png" ImageAlign="right" Height="40px" data-content='<%# Eval("Remark")%>' data-toggle="popover" />
                                            </ItemTemplate>
                                        </asp:TemplateField>                     
                                </Columns>
                                <HeaderStyle CssClass="Headerstyle" />
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Price/Unit ($)">
                                            <ItemTemplate>
                                                ...
                                                <ajax:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" FilterType="Numbers,Custom" ValidChars=".$" runat="server" TargetControlID="PricePerUnit"></ajax:FilteredTextBoxExtender>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Order Qty">
                                            <ItemTemplate>
