    ...
    public partial class ServiceRequest : System.Web.UI.Page
    {
        ...
        protected void btnSaveRow_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (gvSearchSRDetails.FooterRow.Visible == true)
            {
                ...
                Int32 FootSINo = 0;
                List<GetServiceTempAttachment_Result> llstCheckQuotes = lclsservice.GetServiceTempAttachment(FootSINo).ToList();
        ...
        {
            List<GetFacilityVendorAccount_Result> lstvendordetails = null;
            try
            {
                DropDownList drpFooterVendor = gvSearchSRDetails.FooterRow.FindControl("ddlFootVendor") as DropDownList;
                ...
                lstvendordetails = new List<GetFacilityVendorAccount_Result>();
        ...
        public void GetEquipementSubCategory(string Mode)
        {
            ...
            {
                InventoryServiceClient lclsservice = new InventoryServiceClient();
                List<GetEquipementSubCategory_Result> lstequipSubCat = lclsservice.GetEquipementSubCategory(Convert.ToInt64(ddlEquipmentCategory.SelectedValue), Mode).ToList();
        ...
        public void BindServiceList(string Mode)
        {
            try
            {
                List<GetServiceList_Result> lstServiceList = new List<GetServiceList_Result>();
        ...
        public void GetEquipementList(string Mode)
        {
            ...
            {
                InventoryServiceClient lclsservice = new InventoryServiceClient();
                List<GetEquipementList_Result> lstequiplist = lclsservice.GetEquipementList(Convert.ToInt64(ddlEquipmentSubCat.SelectedValue), Mode).ToList();
        ...
        public void BindLookUp(string Mode)
        {
            try
            {
                ...
                List<GetList_Result> lstLookUp = new List<GetList_Result>();
                List<GetList_Result> lstLookUpship = new List<GetList_Result>();
        ...
        public void QueryStringPageLoad()
        {
            try
            {
                ...
                List<GetServiceRequestMaster_Result> lstMPRMaster = lclsservice.GetServiceRequestMaster().Where(a => a.ServiceRequestMasterID == Convert.ToInt64(HddMasterID.Value)).ToList();
                BindDetailGrid(Convert.ToInt64(HddMasterID.Value), Convert.ToInt64(defaultPage.UserId));
                ...
                if (i == 1)
                {
                    ...
                    else
                    {
                        ...
                        if (defaultPage.Req_WorkOrServicePage_Edit == true && defaultPage.Req_WorkOrServicePage_View == true)
                        {
                            ...
                            {
                                List<GetServiceRequestMaster_Result> lstMPRMaster = lclsservice.GetServiceRequestMaster().Where(a => a.FacilityID == Convert.ToInt64(HddFacilityID.Value) && a.ServiceRequestMasterID == Convert.ToInt64(HddMasterID.Value)).ToList();
        ...
        public void BindGrid(int TestEdit)
        {
            try
            {
                ...
                if (TestEdit == 1)
                {
                    ...
                    List<SearchServiceRequestMaster_Result> lstMPRMaster = lclsservice.SearchServiceRequestMaster(llstServiceRequest).ToList();
                    GvTempEdit.DataSource = lstMPRMaster;
                    GvTempEdit.DataBind();
        ...
        public void SearchGrid()
        {
            try
            {
                ...
                llstServiceRequest.LoggedinBy = defaultPage.UserId;
                List<SearchServiceRequestMaster_Result> llstSearchMaster = lclsservice.SearchServiceRequestMaster(llstServiceRequest).ToList();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (GridViewRow grdfs in gvAddSRDetails.Rows)
                {
                    ...
                    List<GetServiceTempAttachment_Result> llstCheckQuotes = lclsservice.GetServiceTempAttachment(Convert.ToInt32(lblSINo.Text)).ToList();
                    if (llstCheckQuotes.Count == 0)
                    {
                ...
                foreach (GridViewRow grdfs in gvSearchSRDetails.Rows)
                {
                    ...
                    List<GetServiceAttachment_Result> llstServiceAttachment = lclsservice.GetServiceAttachment(Convert.ToInt64(lbServiceRequestDetailsID.Text)).ToList();
        ...
        private void SetInitialRow()
        {
            try
            {
                ...
                List<GetFacilityVendorAccount_Result> lstvendordetails = lclsservice.GetFacilityVendorAccount(ddlFacility.SelectedItem.Text).Where(a => a.ServiceOrder == true).ToList();
        ...
        public void BindServiceCategory(Int64 CorporateID, string Mode)
        {
            try
            {
                List<GetServiceCategory_Result> lstServiceCategory = new List<GetServiceCategory_Result>();
        ...
        public void BindEquipcategory(Int64 CorporateID, string Mode)
        {
            ...
            {
                InventoryServiceClient lclsservice = new InventoryServiceClient();
                List<GetEquipmentCategory_Result> lstequipcat = lclsservice.GetEquipmentCategory(CorporateID, Mode).ToList();
        ...
        public void BindDetailGrid(Int64 ServiceMasterID, Int64 UserID)
        {
            try
            {
                ...
                List<GetServiceRequestetailsbyServiceRequestMasterID_Result> llstSRDetails = lclsservice.GetServiceRequestetailsbyServiceRequestMasterID(ServiceMasterID, UserID, Convert.ToInt64(LockTimeOut)).ToList();
                ...
                else if (llstSRDetails[0].IsReadOnly == 1)
                {
                    ...
                    List<GetUserDetails_Result> llstuserdetails = lclsservice.GetUserDetails(Convert.ToInt64(llstSRDetails[0].Lockedby)).ToList();
        ...
        protected void imgprint_Click(object sender, ImageClickEventArgs e)
        {
            ...
            List<BindServiceRequestReport_Result> llstreview = lclsservice.BindServiceRequestReport(smachinePartID, null, defaultPage.UserId, defaultPage.UserId).ToList();
        ...
        protected void btnImgDeletePopUp_Click(object sender, ImageClickEventArgs e)
        {
            ...
            List<CheckServicelist_Result> lstservlist = new List<CheckServicelist_Result>();
        ...
        public void BindServiceAttachment()
        {
            if (HddDetailsID.Value == "0")
            {
                List<GetServiceTempAttachment_Result> llstserviceattach = lclsservice.GetServiceTempAttachment(Convert.ToInt32(HddRowIndex.Value)).ToList();
                GrdUploadFile.DataSource = llstserviceattach;
                GrdUploadFile.DataBind();
            }
            else
            {
                List<GetServiceAttachment_Result> llstServiceAttachment = lclsservice.GetServiceAttachment(Convert.ToInt64(HddDetailsID.Value)).ToList();
        ...
        protected void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            List<BindServiceRequestReport_Result> llstreview = new List<BindServiceRequestReport_Result>();
        ...
        protected void btnaddservicecategory_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        List<GetServiceCategory_Result> lstcount = lclsservice.GetServiceCategory(Convert.ToInt64(ddlFacility.SelectedValue), "Add").Where(o => o.ServiceCatDescription == txtServiceCategory.Text.ToString()).ToList();
                        if (lstcount.Count <= 0)
                        {
                    ...
                    BindServiceCategory(Convert.ToInt64(ddlCorporate.SelectedValue), "Add");
                    List<SavedServiceCategory_Result> lstsave = lclsservice.SavedServiceCategory(Convert.ToInt64(ddlCorporate.SelectedValue), Convert.ToInt64(ViewState["ServiceCatID"])).ToList();
                ...
                try
                {
                    ...
                    if (extension == ".doc" || extension == ".docx" || extension == ".pdf")
                    {
                        ...
                        if (HddDetailsID.Value == "0")
                        {
                            ...
                            List<GetServiceTempAttachment_Result> llstcheckdoc = lclsservice.GetServiceTempAttachment(llstServiceRequest.SNo).ToList();
        ...
        protected void btnaddserviceList_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        List<GetServiceList_Result> lstcount = lclsservice.GetServiceList(ddlServiceCategory.SelectedIndex, "Add").Where(o => o.ServiceListDescription == txtServiceList.Text.ToString()).ToList();
                        if (lstcount.Count <= 0)
                        {
                    ...
                    else
                    {
                        ...
                        {
                            List<GetActiveServiceListvalue_Result> lstactiveServlst = new List<GetActiveServiceListvalue_Result>();
                    ...
                    BindServiceList("Add");
                    List<SavedServiceList_Result> lstservlst = lclsservice.SavedServiceList(Convert.ToInt64(ViewState["ServiceListID"])).ToList();
        ...
        public void InsertServiceRequest()
        {
            ...
            if (a == b && b == "Saved Successfully")
            {
                ...
                btnPrint.Visible = true;
                SetAddScreen("", 0);
                List<GetServiceRequestMaster_Result> lstSRMaster = lclsservice.GetServiceRequestMaster().ToList();
