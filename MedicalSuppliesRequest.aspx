<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Inven.Master" CodeBehind="MedicalSuppliesRequest.aspx.cs" Inherits="WebApplication1.MedicalSuppliesRequest" %>
            ...
            <div id="DivMedicalRequest" runat="server" class="mypanel-body" style="padding: 5px 15px 15px 15px;">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8" align="right">
                        ...
                        <asp:Button ID="btnreviewprint" runat="server" CssClass="btn btn-primary" Text="Print" />
                ...
                <div id="divMedReqSearch" runat="server" style="margin-top: 5px;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-md-4 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <asp:ListBox ID="drpfacilitysearch" runat="server" CssClass="form-control" SelectionMode="Multiple" multiple="multiple" OnSelectedIndexChanged="drpfacilitysearch_SelectedIndexChanged" AutoPostBack="true"></asp:ListBox>
                    ...
                    <div id="divgrdMSRSearch" runat="server" style="margin-left: 1px; margin-top: 3px;" class="divMedReqSearchGrid MSRSearchgrid">
                        <asp:GridView ID="grdMedReqSearch" runat="server" AutoGenerateColumns="false" CssClass="table table-responsive" ShowHeaderWhenEmpty="true" EmptyDataText="No Records Found ">
                            <Columns>
                                <asp:TemplateField HeaderText="Edit" HeaderStyle-Width="6%" ItemStyle-Width="6%">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="imgbtnEdit" runat="server" Text="Edit" Height="20px" ImageUrl="~/Images/edit.png" />
                                        <asp:ImageButton ID="imgprint" runat="server" Text="Edit" Height="20px" ImageUrl="~/Images/Print.png" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                    ...
                    <div id="divMSRContentAddHeader" class="well well-sm" runat="server" style="display: none;">
                        <div class="row">
                            ...
                            <div class="col-sm-3 col-md-3 col-lg-3">
                                <div class="form-group">
                                    <span>Vendor</span>&nbsp;<span style="color: red">*</span>
                                    <asp:DropDownList ID="ddlVendoradd" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlVendoradd_SelectedIndexChanged" ></asp:DropDownList>
                                </div>
                            </div>
                            <div class="col-sm-3 col-md-3 col-lg-3">
                                <div class="form-group">
                                    <span>Order Type</span>&nbsp;<span style="color: red">*</span>
                                    <asp:RadioButtonList ID="rdovendortype" runat="server" RepeatDirection="Horizontal" AutoPostBack="true" CssClass="rbl">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3 col-md-3 col-lg-3" id="divshipping" runat="server" style="display: block;">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="drpshipping" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="drpshipping_SelectedIndexChanged"></asp:DropDownList>
                                </div>
                            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header" style="padding: 8px 5px 0px 5px;">
                            <asp:Button ID="btneditnewitemclose" class="close" runat="server" Text="X" />
                            ...
                            <div class="form-horizontal">
                                <div class="row">
                                    ...
                                    <div class="col-lg-2" align="right">
                                        <asp:Button ID="addnewItem" runat="server" Text="Add To Grid" CssClass="btn btn-primary" />
                                    </div>
                                </div>
                                <div class="row">
                                        ...
                                        <asp:GridView ID="grdeditnewitemadd" runat="server" AutoGenerateColumns="false" CssClass="table table-responsive"
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="Select Item" HeaderStyle-Width="6%">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:CheckBox ID="ckboxselectitem" runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                        ...
                        <div class="modal-body" style="padding: 5px 15px 15px 15px;">
                            <div class="form-horizontal">
                                <div class="row" style="margin-bottom: 2px;">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6" align="right">
                                        <asp:Button ID="btnSave" runat="server" CssClass="btn btn-success" Text="Save" Visible="false" OnClick ="btnSave_Click" />
