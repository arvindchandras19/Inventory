    ...
    public partial class FacilityVendorAccount : System.Web.UI.Page
    {
        ...
        public void BindGrid()
        {
            ...
            try
            {
                ...
                List<SearchFacilityVendorAcct_Result> list = new List<SearchFacilityVendorAcct_Result>();
        ...
        public void BindVendor()
        {
            try
            {
                ...
                List<GetVendor_Result> listVendor = new List<GetVendor_Result>();
        ...
        public void BindFacility()
        {
            try
            {
                List<GetFacility_Result> lstcategory = new List<GetFacility_Result>();
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (obj.FacilityVendorAccID == 0)
                {
                    ...
                    List<GetFacilityVendorAccount_Result> lstcount = service.GetFacilityVendorAccount(drdFacilityName.SelectedItem.Text).Where(o => o.VendorDescription == drdVendorName.SelectedItem.Text.ToString()).ToList();
                    if (lstcount.Count <= 0)
                    {
                ...
                else
                {
                    ...
                    List<GetFacilityVendorAccount_Result> lstcount = service.GetFacilityVendorAccount(drdFacilityName.SelectedItem.Text).Where(o => o.VendorDescription == drdVendorName.SelectedItem.Text.ToString() && o.FacilityVendorAccID != obj.FacilityVendorAccID).ToList();
                    if (lstcount.Count == 0)
                    {
                        lstrMessage = service.InsertUpdateFacilityVendorAccount(obj);
                        FacilityVendorAcct = drdFacilityName.SelectedItem.Text + " " + drdVendorName.SelectedItem.Text;
        ...
        private bool ValidateLoookups(InventoryServiceClient service)
        {
            ...
            string errmessage = "";
            //Facility Lookup
            List<GetFacility_Result> lstfac = service.GetFacility().Where(a => a.IsActive == true && a.FacilityID == Convert.ToInt64(drdFacilityName.SelectedValue)).ToList();
            if (lstfac.Count == 0)
            {
            ...
            //Vendor Lookup
            List<GetvendorDetails_Result> lstvendor = service.GetvendorDetails("").Where(a => a.IsActive == true && a.VendorID == Convert.ToInt64(drdVendorName.SelectedValue)).ToList();
        ...
        public List<object> PrintFacility()
        {
            ...
            List<BindFacilityVendorAccountReport_Result> llstreview = null;
