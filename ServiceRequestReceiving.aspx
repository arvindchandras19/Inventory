<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServiceRequestReceiving.aspx.cs" MasterPageFile ="~/Inven.Master" Inherits="WebApplication1.ServiceRequestReceiving" %>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="SPO NO">
                                                <ItemTemplate>
                                                    ...
                                                    <label ID="lblservice1" runat="server" Text='<%# Eval("Service") %>' CssClass="HeaderHide"></label>
                                                    <label ID="lblunit" runat="server" Text='<%# Eval("Unit") %>' CssClass="HeaderHide"></label>
                                                    <label ID="lblprice" runat="server" Text='<%# Eval("Price", "{0:F2}") %>' CssClass="HeaderHide"></label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="SPRO NO">
                                                <ItemTemplate>
                                                    <linkButton ID="lbrevSRPROno" runat="server" Text='<%# Eval("SPRONo")%>' OnClick="lbrevSRPROno_Click"></linkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Status">
                                                <ItemTemplate>
                                                    <label ID="lblpostatus" runat="server" Text='<%# Eval("Status")%>'></label>
                                                    <label ID="lblAction" runat="server" Text='<%# Eval("Action") %>' CssClass="HeaderHide"></label>
                                                    <label ID="lblIsEdit" runat="server" Text='<%# Eval("IsEdit") %>' CssClass="HeaderHide"></label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
