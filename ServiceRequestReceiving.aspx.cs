    ...
    public partial class ServiceRequestReceiving : System.Web.UI.Page
    {
        ...
        public void BindStatus(string mode)
        {
            try
            {
                ...
                List<GetList_Result> lstreason = new List<GetList_Result>();
        ...
        public void BindRequestPOGrid()
        {
            try
            {
                ...
                List<SearchServiceRequestReceivingOrder_Result> lstSRPOMaster = lclsservice.SearchServiceRequestReceivingOrder(llstSReceivedetails).ToList();
        ...
        protected void lbitono_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                lblservice1.Text = lblservice1.Text;
                ...
                List<GetServiceReceiveOrder_Result> llstSRecieveOrder = lclsservice.GetServiceReceiveOrder(llstSReceivedetails).ToList();
