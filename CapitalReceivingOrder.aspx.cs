    ...
    public partial class CapitalReceivingOrder : System.Web.UI.Page
    {
        ...
        public void SearchCapitalReceiving()
        {
            try
            {
                ...
                List<SearchCapitalReceivingMaster_Result> lstCRMaster = lclsservice.SearchCapitalReceivingMaster(llstcr).ToList();
        ...
        protected void lbcrono_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                List<GetCpoDetails_Result> llstCRDetails = lclsservice.GetCpoDetails(CPO).ToList();
        ...
        public void InsertReceiving()
        {
            try
            {
                ...
                List<UpdateCapitalRecevingMaster_Result> lstCRMaster = lclsservice.UpdateCapitalReceivingMaster(llstcr).ToList();
        ...
        protected void lbCRrno_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                status = gvrow.Cells[14].Text.Trim().Replace("&nbsp;", "");
                List<GetCPROMasterReview_Result> llstCRDetails = lclsservice.GetCPROMasterReview(CPRO).ToList();
                if (llstCRDetails[0].PackingSlipNo != "")
                    packingsilpno.Text = llstCRDetails[0].PackingSlipNo;
                if (Convert.ToString(llstCRDetails[0].PackingDate) != "")
                    txtpackingslip.Text = Convert.ToDateTime(llstCRDetails[0].PackingDate).ToString("MM/dd/yyyy");
        ...
        public List<object> SearchOrderReport(string CapitalItemMasterID)
        {
            ...
            List<GetCapitalPOReport_Result> llstreview = new List<GetCapitalPOReport_Result>();
        ...
        public List<object> DetailsOrderReport(Int64 CapitalItemMasterID)
        {
            ...
            List<GetCROrderContentPO_Result> llstreview = lclsservice.GetCROrderContentPO(llstcrpo).ToList();
        ...
        protected void imgprint_Click(object sender, ImageClickEventArgs e)
        {
            ...
            List<BindCapitalReceivingsummaryReport_Result> llstreview = lclsservice.BindCapitalReceivingsummaryReport(Convert.ToInt64(CapitalOrderID), Convert.ToInt64(defaultPage.UserId), "").ToList();
        ...
        protected void imgprintedit_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                HdnMReqID.Value = gvrow.Cells[3].Text.Trim().Replace("&nbsp;", "");
                HdnMasterID.Value = gvrow.Cells[2].Text.Trim().Replace("&nbsp;", "");
                List<BindCapitalDetailsReport_Result> llstreview = lclsservice.BindCapitalDetailsReport(Convert.ToInt64(HdnMReqID.Value), Convert.ToInt64(HdnMasterID.Value), Convert.ToInt64(defaultPage.UserId), "").ToList();
