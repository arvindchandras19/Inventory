    ...
    public partial class CorporateMaster : System.Web.UI.Page
    {
        ...
        public void SearchGrid()
        {
            try
            {
                ...
                ObjCorporate.CorporateName = "PPG";
                ObjCorporate.CorporateDescription = "PPG HealthCare";
        ...
        public void UpdateCorporate()
        {
            try
            {
                ...
                List<BindCorporateMaster_Result> lstCop = lclsservice.BindCorporateMaster().Where(a => a.CorporateName == ObjCorporate.CorporateName).ToList();
        ...
        protected void imgbtnEdit_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                div_ADDContent.Style.Add("display", "block");
                divCorporate.Style.Add("display", "none");
                List<BindCorporateMaster_Result> lclcor = lclsservice.BindCorporateMaster().Where(a => a.CorporateID == Convert.ToInt64(gvrow.Cells[1].Text)).ToList();
        ...
        protected void btndeleteimg_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                ObjCorporate.LoggedinBy = defaultPage.UserId;
                ObjCorporate.Filter = "";
                List<chkvalidcorporate_Result> lclscorp = lclsservice.chkvalidcorporate(ObjCorporate).ToList();
                if (lclscorp.Count <= 0)
                {
                    DeleteCorporate();
                }
