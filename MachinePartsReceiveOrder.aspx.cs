...
namespace WebApplication1
{
    public partial class MachinePartsReceiveOrder : System.Web.UI.Page
    {
        ...
        //        List<SearchMachinePartsReceive_Result> lstMSRMaster = lclsservice.SearchMachinePartsReceive(lstMp).ToList();
        ...
        protected void lbMPONo_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                List<GETMPOValues_Result> llst = lclsservice.GETMPOValues(MachinePartsReceivingMasterID).ToList();
                ...
                else if (defaultPage.RoleID == 1)
                {
                    ...
                    List<GETMPOValues_Result> llstMPRDetails = lclsservice.GETMPOValues(MachinePartsReceivingMasterID).ToList();
        ...
        protected void lbMPRONo_Click(object sender, EventArgs e)
        {
            try
            {
                if (defaultPage.RoleID == 1)
                {
                    ...
                    List<GETMPROValues_Result> llstMPRDetails = lclsservice.GETMPROValues(MachinePartsReceivingMasterID).ToList();
                    txtPackingSlipNo.Text = llstMPRDetails[0].PackingSlipNo;
                    txtPackingSlipDate.Text = Convert.ToDateTime(llstMPRDetails[0].PackingSlipDate).ToString("MM/dd/yyyy");
                    txtReceivingDate.Text = Convert.ToDateTime(llstMPRDetails[0].ReceivedDate).ToString("MM/dd/yyyy");
                    txtReceivingDate.Text = Convert.ToDateTime(llstMPRDetails[0].ReceivedDate).ToString("MM/dd/yyyy");
        ...
        public void Reviewfields()
        {
            ...
            {
                btnSave.Visible = false;
                List<GETMPROValues_Result> llstMPRDetails = lclsservice.GETMPROValues(Convert.ToInt64(ViewState["MachinePartsReceivingMasterID"])).ToList();
                txtInvoiceNo.Text = llstMPRDetails[0].InvoiceNo;
        ...
        public void Reviewmpo()
        {
            ...
            {
                btnSave.Visible = false;
                List<GETMPOValues_Result> llstMPRDetails = lclsservice.GETMPOValues(Convert.ToInt64(ViewState["MachinePartsReceivingMasterID"])).ToList();
                txtPackingSlipNo.Text = llstMPRDetails[0].PackingSlipNo;
                txtPackingSlipDate.Text = Convert.ToDateTime(llstMPRDetails[0].PackingSlipDate).ToString("MM/dd/yyyy");
                txtReceivingDate.Text = Convert.ToDateTime(llstMPRDetails[0].ReceivedDate).ToString("MM/dd/yyyy");
                txtPackingSlipNo.Enabled = false;
        ...
        public void SaveMachinePartsReceiveMaster()
        {
            try
            {
                ...
                {
                    lstMPR.Type = "TYPE3";
                    List<UpdateMachinePartsReceivingMaster_Result> lstMSRMaster = lclsservice.UpdateMachinePartsReceivingMaster(lstMPR).ToList();
                    SendEmail();
                }
                else
                {
        ...
        public void EmailSetting(Int64 CorporateID, Int64 FacilityID, string MPONo)
        {
            try
            {
                ...
                List<GetSuperAdminDetails_Result> lstsuperadmin = lclsservice.GetSuperAdminDetails(CorporateID, FacilityID).ToList();
        ...
        public List<object> DetailsOrderReport(Int64 MPRMasterID)
        {
            ...
            List<GetMPOrderContentPO_Result> llstreview = lclsservice.GetMPOrderContentPO(MPRMasterID, defaultPage.UserId).ToList();
        ...
        protected void imgsummary_Click(object sender, ImageClickEventArgs e)
        {
            ...
            List<BindMachineReceiveSummaryReport_Result> llstreview = lclsservice.BindMachineReceiveSummaryReport(MachinePartsRequestOrderID, Convert.ToInt64(defaultPage.UserId), "").ToList();
        ...
        protected void imgdetails_Click(object sender, ImageClickEventArgs e)
        {
            ...
            List<BindMachineReceivingDetailsReport_Result> llstreview = lclsservice.BindMachineReceivingDetailsReport(MPRMasterID, Convert.ToInt64(defaultPage.UserId), "").ToList();
