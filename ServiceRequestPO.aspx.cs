    ...
    public partial class ServiceRequestPO : System.Web.UI.Page
    {
        ...
        public void BindRequestPOGrid(string search)
        {
            try
            {
                ...
                if (search == "")
                {
                    List<SearchServiceRequestPurchaseOrder_Result> lstSRPOMaster = lclsservice.SearchServiceRequestPurchaseOrder(llstSRPOdetails).Where(a => a.isEdit != 0).ToList();
                    grdSRPO.DataSource = lstSRPOMaster;
                    grdSRPO.DataBind();
                }
                else
                {
                    List<SearchServiceRequestPurchaseOrder_Result> lstSRPOMaster = lclsservice.SearchServiceRequestPurchaseOrder(llstSRPOdetails).ToList();
                    grdSRPO.DataSource = lstSRPOMaster;
                    grdSRPO.DataBind();
                }
        ...
        protected void lbitrno_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                List<SearchServiceRequestPurchaseOrder_Result> llstSRMasterDetails = lclsservice.SearchServiceRequestPurchaseOrder(llstSRPOdetails).ToList();
        ...
        public void GetServiceRequestDeatilsWithAction(List<SearchServiceRequestPurchaseOrder_Result> llstSRMasterDetails)
        {
            try
            {
                mpserviceorder.Show();
                ...
                llstSRPOdetails.LoggedinBy = defaultPage.UserId;
                List<SearchServiceRequestPurchaseOrderDetails_Result> llstSRDetails = lclsservice.SearchServiceRequestPurchaseOrderDetails(llstSRPOdetails).ToList();
                ...
                foreach (GridViewRow row in grdSROrder.Rows)
                {
                    ...
                    List<GetServiceRequestActionByMasterID_Result> llstSRAction = lclsservice.GetServiceRequestActionByMasterID(Convert.ToInt64(lbServiceRequestMasterID.Text), Convert.ToInt64(lbServiceRequestDetailsID.Text)).ToList();
                    List<GetServiceRequestMaster_Result> llstServiceRequestMaster = lclsservice.GetServiceRequestMaster().Where(a => a.ServiceRequestMasterID == Convert.ToInt64(lbServiceRequestMasterID.Text)).ToList();
                    List<GetServiceRequestActionByMasterID_Result> llstSRActionbyServicedetails = llstSRAction.Where(a => a.ServiceRequestDetailsID == Convert.ToInt64(lbServiceRequestDetailsID.Text)).ToList();
                    ListItem lst1 = new ListItem();
        ...
        public void UpdateServiceRquestPOAction()
        {
            try
            {
                ...
                foreach (GridViewRow row in grdSROrder.Rows)
                {
                    ...
                    List<GetServiceRequestActionByMasterID_Result> llstSRAction = lclsservice.GetServiceRequestActionByMasterID(Convert.ToInt64(lbServiceRequestMasterID.Text), Convert.ToInt64(lbServiceRequestDetailsID.Text)).ToList();
                    List<GetServiceRequestActionByMasterID_Result> llstfilterbyServiceRequestID = llstSRAction.Where(a => a.ServiceRequestDetailsID == Convert.ToInt64(lbServiceRequestDetailsID.Text)).ToList();
                    if (llstSRAction.Count == 0)
                    {
            ...
            try
            {
                ...
                foreach (GridViewRow row in grdSRPO.Rows)
                {
                    ...
                    if (lblpostatus.Text == Constant.PendingApproval || lblpostatus.Text == Constant.PendingOrderStatus || lblpostatus.Text == Constant.HoldStatus || lblpostatus.Text == Constant.DeniedStatus)
                    {
                        ...
                        List<GetServiceRequestActionByMasterID_Result> llstSRAction = lclsservice.GetServiceRequestActionByMasterID(Convert.ToInt64(ServiceMasterId), Convert.ToInt64(ServiceMasterId)).ToList();
                        List<GetServiceRequestPoReportDetails_Result> llstSRdetails = lclsservice.GetServiceRequestPoReportDetails(ServiceMasterId, null, defaultPage.UserId, defaultPage.UserId).ToList();
                ...
                List<GetServiceRequestPOGenerateDetails_Result> llstSRPOGen = new List<GetServiceRequestPOGenerateDetails_Result>();
        ...
        public byte[] DetailsOrderAttachment(Int64 ServiceRequestDetailsID)
        {
            ...
            try
            {
                List<GetServiceAttachment_Result> llstServiceAttachment = lclsservice.GetServiceAttachment(ServiceRequestDetailsID).ToList();
        ...
        public byte[] DetailsContentOrderReport(string ListServiceRequestID, string MultiPrint)
        {
            ...
            try
            {
                List<GetServiceRequestPoReportDetails_Result> llstreview = null;
                if (MultiPrint == "Yes")
                {
        ...
        public byte[] DetailsOrderReport(Int64 ServiceRequestMasterID, Int64 ServiceRequestDetailID)
        {
            ...
            try
            {
                List<GetSROrderContentPOReports_Result> llstreview = lclsservice.GetSROrderContentPOReports(ServiceRequestMasterID, ServiceRequestDetailID, defaultPage.UserId).ToList();
                ...
                string encoding;
                string extension;
                List<GetServiceRequestPOGenerateDetails_Result> llstOrderContent = lclsservice.GetServiceRequestPOGenerateDetails(Convert.ToString(ServiceRequestMasterID), defaultPage.UserId).ToList();
        ...
        protected void imgbtnEmail_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                List<GetServiceRequestActionByMasterID_Result> llstServiceRequestDetailsID = lclsservice.GetServiceRequestActionByMasterID(Convert.ToInt64(gvrow.Cells[1].Text), Convert.ToInt64(gvrow.Cells[1].Text)).Where(a => a.Status == Constant.OrderStatus).ToList();
        ...
        public void BindServiceAttachment()
        {
            try
            {
                List<GetServiceAttachment_Result> llstServiceAttachment = lclsservice.GetServiceAttachment(Convert.ToInt64(HddServiceDetailsID.Value)).ToList();
