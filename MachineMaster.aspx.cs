...
namespace WebApplication1
{
    public partial class MachineMaster : System.Web.UI.Page
    {
        ...
        public void GetEquipementSubCategory(long EquipCatID, string Mode)
        {
            ...
            {
                InventoryServiceClient lclsservice = new InventoryServiceClient();
                List<GetEquipementSubCategory_Result> lstequiplist = lclsservice.GetEquipementSubCategory(EquipCatID, Mode).ToList();
        ...
        public void GetEquipementList(long EquipSubCatID, string Mode)
        {
            ...
            {
                InventoryServiceClient lclsservice = new InventoryServiceClient();
                List<GetEquipementList_Result> lstequiplist = lclsservice.GetEquipementList(EquipSubCatID, Mode).ToList();
                if (lstequiplist.Count > 0)
                {
        ...
        private void BindFacility(string mode)
        {
            ...
            {
                InventoryServiceClient lclsservice = new InventoryServiceClient();
                List<GetCorporateFacility_Result> lstfacility = new List<GetCorporateFacility_Result>();
                if (mode == "Add")
                {
        ...
        public void BindMachinemasterGrid()
        {
            try
            {
                ...
                List<GetMachinemasterDetails_Result> lstmachinemaster = new List<GetMachinemasterDetails_Result>();
                List<SearchMachinemasterdetails_Result> lstmachinemasterID = new List<SearchMachinemasterdetails_Result>();
        ...
        private bool ValidateLoookups(InventoryServiceClient service)
        {
            ...
            List<GetEquipmentCategory_Result> lstCat = service.GetEquipmentCategory(Convert.ToInt64(drpCorporate.SelectedValue), "Add").Where(a => a.EquipmentCategoryID == Convert.ToInt64(drpEquipment.SelectedValue)).ToList();
            if (lstCat.Count == 0)
            {
            ...
            List<GetEquipementSubCategory_Result> lstEquipSub = service.GetEquipementSubCategory(Convert.ToInt64(drpEquipment.SelectedValue), "Add").Where(a => a.EquipementSubCategoryID == Convert.ToInt64(drpEquipmentSubCategory.SelectedValue)).ToList();
            if (lstCat.Count == 0)
            {
            ...
            List<GetEquipementList_Result> lstEquiplist = service.GetEquipementList(Convert.ToInt64(drpEquipmentSubCategory.SelectedValue), "Add").Where(a => a.EquipementListID == Convert.ToInt64(drpEquipmentlist.SelectedValue)).ToList();
            if (lstCat.Count == 0)
            {
            ...
            //Facility Lookup
            List<GetCorporateFacility_Result> lstfac = service.GetCorporateFacility(Convert.ToInt64(drpCorporate.SelectedValue)).Where(a => a.IsActive == true && a.FacilityID == Convert.ToInt64(drpFacility.SelectedValue)).ToList();
            if (lstfac.Count == 0)
            {
        ...
        protected void Imageremoveyes_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                List<CheckEquipmentlist_Result> lstequiplist = new List<CheckEquipmentlist_Result>();
        ...
        protected void lbedit_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                InventoryServiceClient lclsService = new InventoryServiceClient();
                List<GetMachineMasterbasedMachineID_Result> lstmachine = new List<GetMachineMasterbasedMachineID_Result>();
            ...
            try
            {
                ...
                else
                {
                    if (hdnequipcat.Value != "1")
                    {
                        ...
                        {
                            List<GetEquipmentCategory_Result> lstcat = lclserinven.GetEquipmentCategory(Convert.ToInt64(drpFacility.SelectedValue), "Add").Where(o => o.EquipmentCatDescription == txtEquipmentcategory.Text.ToString()).ToList();
                            if (lstcat.Count <= 0)
                            {
                        ...
                        //divmachine.Style.Add("display", "none");
                        BindEquipcategory(Convert.ToInt64(drpCorporate.SelectedValue), "Add");
                        List<SavedEquipmentCategory_Result> lstsave = lclserinven.SavedEquipmentCategory(Convert.ToInt64(drpCorporate.SelectedValue), Convert.ToInt64(ViewState["equipcatID"])).ToList();
            ...
            try
            {
                ...
                else
                {
                    if (hdnequiplist.Value != "1")
                    {
                        ...
                        {
                            List<GetEquipementList_Result> lstEquiplist = lclserinven.GetEquipementList(Convert.ToInt64(drpEquipmentSubCategory.SelectedValue), "Add").Where(o => o.EquipmentListDescription == txtequilist.Text.ToString()).ToList();
                            if (lstEquiplist.Count <= 0)
                            {
                        ...
                        txtequilist.Text = "";
                        deletebtn.Style.Add("display", "none");
                        List<SavedEquipmentList_Result> lstequlst = lclserinven.SavedEquipmentList(Convert.ToInt64(drpEquipmentlist.SelectedValue)).ToList();
                        GetEquipementList(Convert.ToInt64(drpEquipmentSubCategory.SelectedValue), "Add");
                    ...
                    else
                    {
                        ...
                        List<GetActiveEquipementListvalue_Result> lstactiveeqlst = new List<GetActiveEquipementListvalue_Result>();
            ...
            try
            {
                ...
                else
                {
                    if (hdnequipSubCat.Value != "1")
                    {
                        ...
                        {
                            List<GetEquipementSubCategory_Result> lstEquiplist = lclserinven.GetEquipementSubCategory(Convert.ToInt64(drpEquipment.SelectedValue), "Add").Where(o => o.EquipmentSubCategoryDescription == txtequiSubCat.Text.ToString()).ToList();
                            if (lstEquiplist.Count <= 0)
                            {
                        ...
                        txtequiSubCat.Text = "";
                        deletebtn.Style.Add("display", "none");
                        List<SavedEquipmentSubCategory_Result> lstequlst = lclserinven.SavedEquipmentSubCategory(Convert.ToInt64(drpEquipmentSubCategory.SelectedValue)).ToList();
                        GetEquipementSubCategory(Convert.ToInt64(drpEquipment.SelectedValue), "Add");
                    ...
                    {
                        // GetEquipementList(Convert.ToInt64(drpEquipment.SelectedValue));  
                        List<GetActiveEquipementSubCategoryvalue_Result> lstactiveeqlst = new List<GetActiveEquipementSubCategoryvalue_Result>();
        ...
        protected void btnsearchprint_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                objbalmachinemaster.Filter = "";
                InventoryServiceClient lclsservice = new InventoryServiceClient();
                List<GetMachineMasterReport_Result> llstreview = lclsservice.GetMachineMasterReport(objbalmachinemaster).ToList();
        ...
        protected void btnprint_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                objbalmachinemaster.Filter = "";
                List<GetMachineMasterDetailsReport_Result> llstreview = lclsservice.GetMachineMasterDetailsReport(objbalmachinemaster).ToList();
