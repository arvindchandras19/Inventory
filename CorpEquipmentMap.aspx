<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CorpEquipmentMap.aspx.cs" MasterPageFile ="~/Inven.Master" Inherits="WebApplication1.CorpEquipmentMap" %>
                                            ...
                                            <div id="DivEditEquipmentCategory" runat="server" class="form-group" style="display: none;">
                                                ...
                                                <asp:GridView ID="GrdEditEquipmentsub" runat="server" AutoGenerateColumns="false" ShowHeader="false" OnRowEditing="GrdEditEquipmentsub_RowEditing"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label1" runat="server" Text='<%# Eval("EquipmentSubCategoryDescription") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
