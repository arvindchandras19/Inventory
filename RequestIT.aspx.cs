    ...
    public partial class RequestIT : System.Web.UI.Page
    {
        ...
        public void SearchGrid()
        {
            try
            {
                ...
                List<SearchITRequest_Result> lstMSRMaster = lclsservice.SearchITRequest(llstITSearch).ToList();
            ...
            try
            {
                ...
                if (HddMasterID.Value == "" || gvSearchMRPDetails.PageCount == 0)
                {
                    foreach (GridViewRow grdfs in gvAddITRDetails.Rows)
                    {
                        ...
                        List<ValidITEquipment_Result> lstMaster = lclsservice.ValidITEquipment(revEquipcat, revEquiplist, revfaclityid).ToList();
                ...
                else
                {
                    ...
                    if (ErrorList == "" && gvSearchMRPDetails.FooterRow.Visible == true)
                    {
                        ...
                        List<ValidITEquipment_Result> lstMaster = lclsservice.ValidITEquipment(FootEquipcat, FootEquiplist, Footfaclityid).ToList();
                        if (lstMaster[0].Edit == 1)
                        {
                            isevalid = true;
                        }
        ...
        public void bindreview()
        {
            try
            {
                ...
                else
                {
                    DivMPRMasterNoreview.Style.Add("display", "block");
                    lblmprreview.Visible = true;
                    List<GetRequestITMaster_Result> llstmpr = lclsservice.GetRequestITMaster().Where(a => a.RequestITMasterID == Convert.ToInt64(HddMasterID.Value)).ToList();
        ...
        public void BindDetailsgridfromPO(string ITRNO)
        {
            try
            {
                List<BindRequestITDetailsfromPO_Result> lstpo = new List<BindRequestITDetailsfromPO_Result>();
        ...
        protected void btnPrint_Click(object sender, EventArgs e)
        {
            try
            {
                List<BindRequestITPartsReport_Result> llstreview = null;
        ...
        public void BindDetailGrid(Int64 RequestITMasterID, Int64 UserId)
        {
            try
            {
                ...
                List<GetITRequestDetailsbyMasterID_Result> llstMPRMaster = lclsservice.GetITRequestDetailsbyMasterID(RequestITMasterID, UserId, Convert.ToInt64(LockTimeOut)).ToList();
                if (llstMPRMaster.Count > 0)
                {
                    ...
                    else if (llstMPRMaster[0].IsReadOnly == 1)
                    {
                        ...
                        List<GetUserDetails_Result> llstuserdetails = lclsservice.GetUserDetails(Convert.ToInt64(llstMPRMaster[0].Lockedby)).ToList();
        ...
        protected void imgprint_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                List<BindRequestITPartsReport_Result> llstreview = lclsservice.BindRequestITPartsReport(ITRequestID, null, defaultPage.UserId, defaultPage.UserId).ToList();
                rvITRequestreport.ProcessingMode = ProcessingMode.Local;
                rvITRequestreport.LocalReport.ReportPath = Server.MapPath("~/Reports/ITRequest.rdlc");
        ...
        public void BindEquipcategory(Int64 CorporateID, string Mode)
        {
            try
            {
                ...
                List<BindEquipementsubcategoryFORIT_Result> lstequipcat = lclsservice.BindEquipementsubcategory(Convert.ToInt64(ddlCorporate.SelectedValue), Mode).ToList();
        ...
        public void BindFooterEquipList(Int64 EquipmentsubcatID, string Mode)
        {
            ...
            try
            {
                ...
                DropDownList ddlFooteequiplst = gvSearchMRPDetails.FooterRow.FindControl("ddlFooteequiplst") as DropDownList;
                // Insert Drop Down                
                List<BindEquipementListFORIT_Result> lstequiplist = lclsservice.BindEquipementListFORIT(EquipmentsubcatID, Mode).ToList();
        ...
        public void InsertRequestIT()
        {
            try
            {
                ...
                if (b == "Saved Successfully")
                {
                    ...
                    // }
                    // SearchGrid();
                    List<GetRequestITMaster_Result> lstMSRMaster = new List<GetRequestITMaster_Result>();
        ...
        public void UpdateRequestIT()
        {
            try
            {
                ...
                {
                    List<GetMPRMaster_Result> lstMPRMaster = lclsservice.GetMPRMaster().ToList();
        ...
        public List<BindEquipementListFORIT_Result> BindEquipementListFORIT(int EquimentSubCategoryID, string Mode)
        {

            InventoryServiceClient lclsservice = new InventoryServiceClient();
            List<BindEquipementListFORIT_Result> lstequiplist = lclsservice.BindEquipementListFORIT(EquimentSubCategoryID, Mode).ToList();
            return lstequiplist;
        }
        ...
        protected void gvAddITRDetails_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    List<BindEquipementsubcategoryFORIT_Result> lstequipcat = lclsservice.BindEquipementsubcategory(CorporateID, Mode).ToList();
