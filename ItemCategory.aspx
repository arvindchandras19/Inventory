<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ItemCategory.aspx.cs" MasterPageFile ="~/Inven.Master" Inherits="WebApplication1.ItemCategory" %>
        ...
        <div class="mypanel-body" style="padding: 5px 15px 15px 15px;">
            ...
            <div id="divsearchgrid" runat="server">
                ...
                <div class="row Itemcategrid" style="margin-left: 1px;">
                    <asp:GridView ID="grdpgroup" runat="server" ShowHeaderWhenEmpty="true" OnRowDataBound="grdpgroup_RowDataBound" AutoGenerateColumns="false" overflow-y="scroll" EmptyDataText="No Records Found" CssClass="table table-responsive">
                        <Columns>
