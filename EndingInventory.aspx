<%@ Page Language="C#" Title="Ending Inventory" AutoEventWireup="true" CodeBehind="EndingInventory.aspx.cs" MasterPageFile ="~/Inven.Master"  Inherits="WebApplication1.EndingInventory" %>
                                        ...
                                        <asp:GridView ID="GrdAddnewItem" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataText="No Records Found" CssClass="table table-responsive">
                                            <Columns>
                                                <asp:TemplateField HeaderText="Sl No" HeaderStyle-Width="5%" HeaderStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <%# Container.DataItemIndex + 1 %>
                                                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("EndingInvenID") %>' CssClass="HeaderHide"></asp:Label>
                                                        <asp:Label ID="Label2" runat="server" Text='<%# Eval("CorporateID") %>' CssClass="HeaderHide"></asp:Label>
                                                        <asp:Label ID="Label3" runat="server" Text='<%# Eval("FacilityID") %>' CssClass="HeaderHide"></asp:Label>
                                                        <asp:Label ID="Label4" runat="server" Text='<%# Eval("CategoryID") %>' CssClass="HeaderHide"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:BoundField DataField="ItemID" HeaderText="Item ID" />
                                                <asp:TemplateField HeaderText="Vendor Item ID">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label5" runat="server" Text='<%# Eval("VendorItemID") %>' ReadOnly="true"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Recv Qty(In Each)">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label6" runat="server" Text='<%# Eval("ReceiveingOrderInvQty") %>'></asp:Label>
                                                        <asp:Label ID="Label7" runat="server" Text='<%# Eval("ReceiveDate") %>' CssClass="HeaderHide"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Trans In(In Each)">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label8" runat="server" Text='<%# Eval("TransferInQty") %>'></asp:Label>
                                                        <asp:Label ID="Label9" runat="server" Text='<%# Eval("TransferINDate") %>' CssClass="HeaderHide"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Trans Out(In Each)">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:Label ID="Label10" runat="server" Text='<%# Eval("TransferOutDate") %>' CssClass="HeaderHide"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Mon.Usage(In Each)">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label11" runat="server" Text='<%# Eval("MonthlyUsage") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                            <HeaderStyle CssClass="Headerstyle" />
                                        ...
                                        <asp:GridView ID="GrdReceiveqty" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataText="No Records Found" CssClass="table table-responsive">
                                            <Columns>
                                                <asp:TemplateField HeaderText="Sl No" HeaderStyle-Width="5%" HeaderStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <%# Container.DataItemIndex + 1 %>
                                                        <asp:Label ID="Label12" runat="server" Text='<%# Eval("ItemID") %>' CssClass="HeaderHide"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                    ...
                                    <div id="DevGrdTransferOutQty">
                                        <asp:GridView ID="GrdTransferOutQty" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataText="No Records Found" CssClass="table table-responsive" OnRowDataBound="GrdTransferOutQty_RowDataBound">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Audit Trail" HeaderStyle-Width="17%">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label13" runat="server" Text=' <%# Eval("Audit")%>'></asp:Label>
                                                        <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/Readmore.png" ImageAlign="Right" Height="30px" data-content='<%# Eval("Audit") %>' data-toggle1="popover" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                            <HeaderStyle CssClass="Headerstyle" />
