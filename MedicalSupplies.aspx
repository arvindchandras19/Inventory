<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MedicalSupplies.aspx.cs" MasterPageFile ="~/Inven.Master" Inherits="WebApplication1.MedicalSupplies" %>
                    ...
                    <div id="searchdiv" runat="server">
                        ...
                        <div id="div_Grid" style="margin-top: 0px;">
                            ...
                            <div class="row vendormastergrid" style="margin-left: 1px;">
                                <asp:GridView ID="grditem" runat="server" ShowHeaderWhenEmpty="true" OnRowDataBound="grditem_RowDataBound" AutoGenerateColumns="false" overflow-y="scroll" EmptyDataText="No Records Found" CssClass="table table-responsive">
                                    <Columns>
                        ...
                        <div class="row vendormastergrid" style="margin-left: 1px;">
                            <asp:GridView ID="grditemmap" runat="server" AutoGenerateColumns="false" EmptyDataText="No Records" ShowHeaderWhenEmpty="true" CssClass="table table-responsive" GridLines="None">
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Active">
                                        <ItemTemplate>
                                            <asp:Label ID="Label1" runat="server" Text='<%# ((string)Eval("IsActive").ToString() == "True" ? "Yes" : "No")  %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                                <HeaderStyle CssClass="Headerstyle" />
