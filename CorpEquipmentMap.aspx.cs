    ...
    public partial class CorpEquipmentMap : System.Web.UI.Page
    {
        ...
        public void BindGrid()
        {
            try
            {
                ...
                List<BindEquipement_Result> lstMPRMaster = lclsservice.BindEquipement(ObjSearchEquipment).ToList();
        ...
        public void InsertEquipmentCategory()
        {
            try
            {
                ...
                List<BindEquipement_Result> lstMPRMaster1 = lclsservice.BindEquipement(ObjSearchEquipment).Where(o => o.EquipmentCatDescription == objbalEquipmentSubCatmaster.EquipementCategorydesc).ToList();
                ...
                if (a == "Saved Successfully")
                {
                    if (GrdAddEquipmentsub.Rows.Count != 0)
                    {
                        ...
                        if (a == "Saved Successfully")
                        {
                            ...
                            txtEquipmentSubCategory.Text = "";
                            btnAddSave.Text = "Add";
                            List<BindEquipement_Result> lstMPRMaster = lclsservice.BindEquipement(ObjSearchEquipment).Where(b => b.EquipmentCategoryID == Convert.ToInt64(lstIDwithmessage[1]) && b.IsActive == true).ToList();
        ...
        public void UpdateEquipmentCategory()
        {
            try
            {
                ...
                ObjSearchEquipment.Filter = "";
                HddEquiSubCatList.Value = "";
                List<BindEquipement_Result> lstEquisubcatMaster = lclsservice.BindEquipement(ObjSearchEquipment).Where(o => o.EquipmentCategoryID == objbalEquipmentSubCatmaster.EquipementCategoryID).ToList();
                ...
                if (GrdAddEquipmentsub.Rows.Count != 0)
                {
                    ...
                    if (lstEquisubcatMaster[0].EquipmentCatDescription == txtEquipmentCategory.Text || a == "Saved Successfully")
                    {
                        foreach (GridViewRow grdfs in GrdAddEquipmentsub.Rows)
                        {
                            ...
                            objbalEquipmentSubCatmaster.EquipementCategoryID = Convert.ToInt64(HddEquipmentCategoryID.Value);
                            objbalEquipmentSubCatmaster.CreatedBy = defaultPage.UserId;
                            List<BindEquipement_Result> lstMPRMaster2 = lclsservice.BindEquipement(ObjSearchEquipment).Where(o => o.EquipmentCategoryID == objbalEquipmentSubCatmaster.EquipementCategoryID && o.EquipmentSubCategoryDescription == objbalEquipmentSubCatmaster.EquipementSubCategorydesc).ToList();
                    ...
                    if (a == "Saved Successfully")
                    {
                        ...
                        txtEquipmentSubCategory.Text = "";
                        btnAddSave.Text = "Add";
                        List<BindEquipement_Result> lstMPRMaster = lclsservice.BindEquipement(ObjSearchEquipment).Where(b => b.EquipmentCategoryID == Convert.ToInt64(HddEquipmentCategoryID.Value) && b.IsActive == true).ToList();
                        GrdEditEquipmentsub.DataSource = lstMPRMaster;
                        GrdEditEquipmentsub.DataBind();
                        SetAddScreen("", 0);
                ...
                else
                {
                    ...
                    if ((lstEquisubcatMaster[0].EquipmentCatDescription == txtEquipmentCategory.Text || a == "Saved Successfully") && txtEquipmentSubCategory.Text != "")
                    {
                        ...
                        List<BindEquipement_Result> lstMPRMaster2 = lclsservice.BindEquipement(ObjSearchEquipment).Where(o => o.EquipmentCatDescription == objbalEquipmentSubCatmaster.EquipementCategorydesc && o.EquipmentSubCategoryDescription == objbalEquipmentSubCatmaster.EquipementSubCategorydesc).ToList();
        ...
        protected void btnPrint_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                List<BindEquipement_Result> llstreview = null;
                BALCorporate ObjSearchEquipment = new BALCorporate();
        ...
        public void SearchGrid(string SearchData)
        {
            try
            {
                List<BindEquipement_Result> lstMPRMaster = null;
                BALCorporate ObjSearchEquipment = new BALCorporate();
            ...
            try
            {
                if (txtEquipmentSubCategory.Text != "")
                {
                    ...
                    else if (HddAddorEdit.Value == "Edit")
                    {
                        ...
                        ObjSearchEquipment.Filter = "";
                        List<BindEquipement_Result> lstMPRMaster = lclsservice.BindEquipement(ObjSearchEquipment).Where(a => a.EquipmentCategoryID == Convert.ToInt64(HddEquipmentCategoryID.Value) && a.IsActive == true).ToList();
                        GrdEditEquipmentsub.DataSource = lstMPRMaster;
                        GrdEditEquipmentsub.DataBind();
                    }
                }
        ...
        protected void lbEquipmentSearchedit_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                ObjSearchEquipment.Mode = "Add";
                ObjSearchEquipment.Filter = "";
                List<BindEquipement_Result> lstMPRMaster = new List<BindEquipement_Result>();
