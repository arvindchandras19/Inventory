<%@ Page Title="Request-Major Items Request" Language="C#" MasterPageFile="~/Inven.Master" AutoEventWireup="true" CodeBehind="CapitalItem.aspx.cs" Inherits="WebApplication1.CapitalItem" %>
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Edit" HeaderStyle-Width="6%" ItemStyle-Width="6%">
                                        <ItemTemplate>
                                            ...
                                            <asp:ImageButton ID="ImageButton1" runat="server" Text="Edit" Height="20px" ToolTip="Print" ImageUrl="~/Images/Print.png" OnClick="imgprint_Click" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="CorporateID" HeaderText="CorporateID" HeaderStyle-CssClass="HeaderHide" ItemStyle-CssClass="HeaderHide" />
                                    <asp:BoundField DataField="FacilityID" HeaderText="FacilityID" HeaderStyle-CssClass="HeaderHide" ItemStyle-CssClass="HeaderHide" />
                                    ...
                                    <asp:TemplateField HeaderText="Remarks"  HeaderStyle-Width="6%">
                                        <ItemTemplate>
                                            <%--<asp:Label ID="lblRemarks" runat="server" Text=' <%# Eval("Remarks")%>'></asp:Label>--%>
                                            <asp:Image ID="Image2" runat="server" ImageUrl="~/Images/Readmore.png" Height="40px" data-content='<%# Eval("Remarks")%>' data-toggle="popover" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="CapitalItemMasterID" HeaderText="CRMasterID" HeaderStyle-CssClass="HeaderHide" ItemStyle-CssClass="HeaderHide" />
                                    ...
                                    <Columns>
                                      ...
                                      <asp:TemplateField HeaderText="SerialNo">
                                        ...
                                        <asp:TemplateField HeaderText="Qty" HeaderStyle-Width="10%">
                                            ...
                                            <FooterTemplate>
                                                <asp:Label ID="Label1" runat="server" Text="" CssClass="hidden"/>
                                      ...
                                      <asp:TemplateField HeaderText="SerialNo">
                                        ...
                                        <asp:TemplateField HeaderText="Qty">
                                            <ItemTemplate>
                                               ...
                                               <ajax:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" FilterType="Numbers" runat="server" TargetControlID="txtqty"></ajax:FilteredTextBoxExtender>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Total Price ($)">
                                            <ItemTemplate>
                                                <div class="Currency-group">
                                                    ...
                                                    <asp:TextBox ID="TextBox3" runat="server"  CssClass="form-control" disabled="true"/>
                                                </div>
