<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MedicalSuppliesReceivingOrder.aspx.cs" MasterPageFile ="~/Inven.Master" Inherits="WebApplication1.MedicalSuppliesReceivingOrder" %>
            ...
            <ContentTemplate>
                ...
                <div id="DivMedicalReceive" runat="server" class="mypanel-body" style="padding: 5px 15px 15px 15px;">
                    ...
                    <div id="divgrdMSRSearch" runat="server" style="margin-left: 1px; margin-top: 3px;" class="divMedReqSearchGrid MSRSearchgrid">
                        <asp:GridView ID="grdReciveSearch" runat="server" AutoGenerateColumns="false" CssClass="table table-responsive" ShowHeaderWhenEmpty="true" EmptyDataText="No Records Found" OnRowDataBound="grdReciveSearch_RowDataBound">
                            <Columns>
                                            ...
                                            <div class="SRReviewgrid">
                                                ...
                                                <asp:GridView ID="grdmsrreviewdeatils" runat="server" ShowHeaderWhenEmpty="true" EmptyDataText="No Records Found" AutoGenerateColumns="false" CssClass="table table-responsive" OnRowDataBound="grdmsrreviewdeatils_RowDataBound" ShowFooter="true" Style="display: none">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="ItemID" HeaderStyle-Width="5%" Visible="false">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label1" Text='<%#Eval("SNGItemID") %>' runat="server"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Item Group" HeaderStyle-Width="12%">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label2" Text='<%#Eval("CategoryName") %>' runat="server"></asp:Label>
                                                                <asp:Label ID="Label3" runat="server" Text='<%#Eval("MedicalSuppliesReceivingDetailsID") %>' CssClass="HeaderHide"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                         <asp:TemplateField HeaderText="Vendor Item ID" HeaderStyle-Width="8%">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Item Description">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label4" Text='<%#Eval("ItemDescription") %>' runat="server"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="UOM" HeaderStyle-Width="5%">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label5" Text='<%#Eval("UOM") %>' runat="server"></asp:Label>
                                                                <%-- <asp:Label ID="lbluomvalue" Text='<%#Eval("UomID") %>' runat="server" Style="display: none;"></asp:Label>--%>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Qty/ Pack" HeaderStyle-Width="4%">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label6" Text='<%#Eval("QtyPack") %>' runat="server"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Price($)" HeaderStyle-Width="8%">
                                                            <ItemTemplate>
                                                                <span id="dolloredititemprice">$</span>
                                                                <asp:Label ID="Label7" Text='<%#Eval("Price","{0:F2}") %>' runat="server"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Order Qty" HeaderStyle-Width="4%">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label8" runat="server" Text='<%#Eval("OrderQty") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Balance Qty" HeaderStyle-Width="5%">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label9" Text='<%#Eval("BalanceQty") %>' runat="server"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Received Qty" HeaderStyle-Width="9%">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="TextBox1" Text='<%#Eval("ReceivedQty") %>' Enabled="false" runat="server" Width="80%"></asp:TextBox>
                                                            </ItemTemplate>
                                                            <FooterTemplate>
                                                                <span style="font-weight: 600; color: black">Shipping Cost</span>
                                                                <br />
                                                        ...
                                                        <asp:TemplateField HeaderText="Total($)" HeaderStyle-Width="10%">
                                                            <ItemTemplate>
                                                                <span id="dolloredititemtotal">$</span>
                                                                <asp:Label ID="Label10" runat="server" Text='<%#Eval("TotalPrice","{0:F2}") %>'></asp:Label>
                                                            </ItemTemplate>
                                                            <FooterTemplate>
                                                                <span style="color: black">$</span>
                                                                <asp:TextBox ID="TextBox2" Text='<%#Eval("Shipping") %>' Width="80%" onblur="GetadminShipValue(this)" onchange="GetadminShipValue(this)" runat="server" ForeColor="Black" CssClass="txtshipcostclass"></asp:TextBox><br />
                                                                <ajax:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" FilterType="Numbers,Custom" ValidChars="." runat="server" TargetControlID="txtshipcost"></ajax:FilteredTextBoxExtender>
                                                                <br />
                                                                <span style="color: black">$</span>
                                                                <asp:TextBox ID="TextBox3" Text='<%#Eval("Tax") %>' Width="80%" onblur="GetadminTaxVal(this)" onchange="GetadminTaxVal(this)" runat="server" ForeColor="Black" CssClass="txttaxclass"></asp:TextBox>
                                                                <ajax:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" FilterType="Numbers,Custom" ValidChars="." runat="server" TargetControlID="txttax"></ajax:FilteredTextBoxExtender>
                                                                <br />
                                                                <br />
                                                                <span style="color: black">$</span>
                                                                <asp:TextBox ID="TextBox4" runat="server" Width="90%" Text='<%#Eval("TotalCost") %>' Style="font-weight: 800; color: Black"></asp:TextBox>
                                                            </FooterTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Comments" HeaderStyle-Width="15%">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="TextBox5" runat="server" Text='<%#Eval("Comments") %>' Enabled="false"></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                    <HeaderStyle CssClass="Headerstyle" />
