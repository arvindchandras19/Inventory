    ...
    public partial class FacilitySuppliesMap : System.Web.UI.Page
    {
        ...
        public void BindCategory()
        {
            try
            {
                ...
                if (HddCuurentStatus.Value == "Search")
                {
                    ...
                    List<GetCategoryByListVendorID_Result> lstcategory = lclsservice.GetCategoryByListVendorID(FinalString).ToList();
                ...
                {
                    List<GetItemMap_Result> lstcategory = lclsservice.GetItemMap().Where(a => a.VendorName == drpvendor.SelectedItem.Text).Where(a => a.IsActive == true).ToList();
            ...
            try
            {
                ...
                if (btnSave.Text == "Review")
                {
                    ...
                    foreach (GridViewRow grdfs in grdFacilitySupply.Rows)
                    {
                        ...
                        List<BindVendorOrderDue_Result> lstOrdertype = lclsService.BindVendorOrderDue(objbalFacilitySupply).ToList();
                        ...
                        List<BindItem_Result> llstItemperpack = lclsService.binditem("").Where(b => b.ItemID == objbalFacilitySupply.ItemID).ToList();
                        ...
                        if (lstOrdertype.Count > 0)
                        {
                            ...
                            List<BindFacility_Result> lstfacility = lclsService.BindFacility(lclfacility).Where(c => c.FacilityID == objbalFacilitySupply.FacilityID).ToList();
                            Int64 Txtweek = 0;
            ...
            try
            {
                ...
                if (HddCuurentStatus.Value == "Search")
                {
                    ...
                    if (drpcopSearch.SelectedIndex != 0 && drpfacilitySearch.SelectedIndex != 0 && ListDrpVedorItem != "" && ListDrpItemCategory != "")
                    {
                        ...
                        List<BindFacility_Result> lstfacility = lclsService.BindFacility(lclfacility).Where(c => c.FacilityID == objFacilitySupply.FacilityID).ToList();
        ...
        protected void btnprint_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                List<GetFacilitySuppliesMapReport_Result> llstreview = new List<GetFacilitySuppliesMapReport_Result>();
