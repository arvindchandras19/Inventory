<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile ="~/Inven.Master" CodeBehind="ServiceRequest.aspx.cs" Inherits="WebApplication1.ServiceRequest" %>
                                ...
                                <asp:GridView ID="GvTempEdit" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataText="No Records Found" OnRowDataBound="grdSRMaster_RowDataBound" CssClass="table table-responsive">
                                    <Columns>
                                        <asp:TemplateField HeaderText="Edit"  HeaderStyle-Width="6%">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="ImageButton1" runat="server" Text="Edit" Height="20px" ImageUrl="~/Images/edit.png" OnClick="imgbtnEdit_Click" />
                                                <asp:ImageButton ID="ImageButton2" runat="server" Text="Edit" Height="20px" ImageUrl="~/Images/Print.png" OnClick="imgprint_Click" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:BoundField DataField="CreatedOn" HeaderText="Date Created" DataFormatString="{0:MM/dd/yyyy}" HeaderStyle-Width="10%" />
                                        <asp:BoundField DataField="CorporateName" HeaderText="Corp"  HeaderStyle-Width="8%"/>
                                        ...
                                        <asp:TemplateField HeaderText="Audit Trail" HeaderStyle-Width="6%">
                                            <ItemTemplate>
                                                <%--<asp:Label ID="lblCreatedBy" runat="server" Text=' <%# Eval("CreatedBy")%>'></asp:Label>--%>
                                                <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/Readmore.png" ImageAlign="Right" Height="40px" data-content='<%# Eval("Audit") %>' data-toggle1="popover" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Remarks" HeaderStyle-Width="6%">
                                            <ItemTemplate>
                                                <%--<asp:Label ID="lblRemarks" runat="server" Text=' <%# Eval("Remarks")%>'></asp:Label>--%>
                                                <asp:Image ID="Image2" runat="server" ImageUrl="~/Images/Readmore.png" ImageAlign="Right" Height="40px" data-content='<%# Eval("Remarks")%>' data-toggle="popover" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    ...
                                    <asp:GridView ID="gvSearchSRDetails" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataText="No Records Found" CssClass="table table-responsive">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Quote" HeaderStyle-Width="30px" ItemStyle-Width="30px">
                                                ...
                                                <FooterTemplate>
                                                    <asp:ImageButton ID="ImageButton3" runat="server" Height="20px" ImageUrl="~/Images/Attachment.png" OnClick="btnImgUploadQuote_Click" />
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            <%--<asp:BoundField DataField="ServiceRequestMasterID" HeaderText="ServiceRequestMasterID" HeaderStyle-CssClass="HeaderHide" ItemStyle-CssClass="HeaderHide"/>
                                ...
                                <div class="SRAddgrid">
                                    <asp:GridView ID="gvAddSRDetails" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataText="No Records Found" CssClass="table table-responsive">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Service">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="TextBox1" runat="server" CssClass="Textbox_Size" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Unit">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="TextBox2" runat="server" CssClass="Textbox_Size" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Price($)">
                                                <ItemTemplate>
                                                    <div class="Currency-group">
                                                        ...
                                                        <asp:TextBox ID="TextBox3" runat="server" CssClass="Textbox_Size" DataFormatString="{0:F2}" />
                                                        <ajax:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" FilterType="Numbers,Custom" ValidChars="." runat="server" TargetControlID="Price"></ajax:FilteredTextBoxExtender>
                                                    </div>
                                            ...
                                            <asp:TemplateField HeaderText="Quote">
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="ImageButton4" runat="server" Height="20px" ImageUrl="~/Images/Upload.png" OnClick="btnImgUploadQuote_Click" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
